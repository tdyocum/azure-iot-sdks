...
//        try
//        {
//            Future<Boolean> messageSent = new Future<>();
//            com.microsoft.azure.iothub.MessageCallback callback = new MessageCallback();
//            client.setMessageCallback(callback, messageSent);
//
...
//            serviceClient.close();
//
//            Boolean result = messageSent.get(5, TimeUnit.SECONDS);
//
//            if (!result)
//            {
...
//            Future<Boolean> messageSent = (Future<Boolean>)context;
...
//                }
//            }
//            messageSent.complete(resultValue);
