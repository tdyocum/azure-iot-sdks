...
//            @Mocked final Future<Integer> mockFuture)
//    {
//        final String hostName = "test.host.name";
//        final String deviceId = "test-deviceId";
//        final String userName = "test-deviceId@sas.test.host.name";
...
//    }
//
//    // Tests_SRS_AMQPSIOTHUBCONNECTIONBASEHANDLER_14_016: [If the link was locally closed before the current message is sent, the sent message Future will be completed exceptionally with a new HandlerException.]
//    @Test
...
//        AmqpsIotHubConnectionBaseHandler handler = new AmqpsIotHubConnectionBaseHandler(hostName, userName, sasToken, deviceId, iotHubClientProtocol, mockIotHubConnection);
//
//        Deencapsulation.setField(mockIotHubConnection, "reactorReady", new Future<Boolean>());
//        handler.onConnectionLocalOpen(mockEvent);
//        Future<Boolean> future = Deencapsulation.getField(mockIotHubConnection, "reactorReady");
//
//        future.get();
//    }
//
//    // Tests_SRS_AMQPSIOTHUBCONNECTIONBASEHANDLER_14_035: [If the Connection was remotely closed abnormally, the event handler shall complete the sent message Future with a new HandlerException.]
//    @Test
...
//    }
//
//    // Tests_SRS_AMQPSIOTHUBCONNECTIONBASEHANDLER_14_051: [The method shall get the link credit from the Future link credit object.]
//    @Test
...
//        AmqpsIotHubConnectionBaseHandler handler = new AmqpsIotHubConnectionBaseHandler(hostName, userName, sasToken, deviceId, iotHubClientProtocol, mockIotHubConnection);
//        Deencapsulation.setField(handler, "sender", mockSender);
//        handler.sendBinaryMessage(msgBody, null);
//
//        new Verifications()
//        {
//            {
...
//        Deencapsulation.setField(handler, "sender", mockSender);
//        handler.sendBinaryMessage(msgBody, null);
//        handler.sendBinaryMessage(msgBody, messageId);
//
//        new Verifications()
//        {
//            {
...
//    }
//
//    // Tests_SRS_AMQPSIOTHUBCONNECTIONBASEHANDLER_14_047: [The function shall return a new Future for the sent message.]
//    @Test
...
//        Deencapsulation.setField(handler, "sender", mockSender);
//
//        Future<Integer> actualFuture = handler.sendBinaryMessage(msgBody, messageId);
//
//        assertEquals(Future.class, actualFuture.getClass());
//    }
//
